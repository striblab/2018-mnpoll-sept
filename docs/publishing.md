...
```html
<div data-pym-src="https://static.startribune.com/news/projects/all/2018-mnpoll-sept">Loading...</div>
...
1.  Create an LCD that is connected to the Article.
    ...
    * Common values in the LCD to use:
      ...
      * `styles`: `news/projects/all/2018-mnpoll-sept/styles.bundle.css`
      * `scripts`: `news/projects/all/2018-mnpoll-sept/app.bundle.js`
...
```js
{
  "publish": {
    "default": {
      ...
      "path": "news/projects-staging/all/2018-mnpoll-sept/",
      "url": "http://static.startribune.com/news/projects-staging/all/2018-mnpoll-sept/"
    },
    "production": {
      "bucket": "static.startribune.com",
      "path": "news/projects/all/2018-mnpoll-sept/",
      "url": "http://static.startribune.com/news/projects/all/2018-mnpoll-sept/"
    }
  }
}
```
